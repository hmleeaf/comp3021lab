...
public class NoteBookWindow extends Application {
	...
	private void updateListView(String search) {
		...
		if (search.equals(""))
			...
			notes = folder.searchNotes(search);
		for (Note n : notes) {
	...
	private GridPane addGridPane() {
		...
		ImageView saveView = new ImageView(new Image(new File("img/save.png").toURI().toString()));
		saveView.setFitHeight(18);
		saveView.setFitWidth(18);
		saveView.setPreserveRatio(true);

		ImageView deleteView = new ImageView(new Image(new File("img/delete.png").toURI().toString()));
