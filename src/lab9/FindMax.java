...
public class FindMax {
	...
	public void printMax() {
		TaskFindMax task1 = new TaskFindMax(0, 29);
		TaskFindMax task2 = new TaskFindMax(30, 59);
		TaskFindMax task3 = new TaskFindMax(60, 89);
		...
		int max = Math.max(task1.getOutput(), Math.max(task2.getOutput(), task3.getOutput()));
	...
	class TaskFindMax implements Runnable {
		private final int begin, end;
		private int output;

		public TaskFindMax(int begin, int end) {
			this.begin = begin;
			this.end = end;
		}
